  ...
  checkNavActiveOnLoad() {
    ...
    this.httpService.call('userinfo', ApiMethod.GET, {}).subscribe((res: any) => {
      if (res.status == true) {
        ...
        this.menuItems.push(
          {
            title: this.dic.translate('Home'), status: true, icon: 'fe fe-home', type: 'link', path: '/group', badgeType: 'success', badgeValue: '2', active: false,
          },
        )
        if (resources.includes('group:it'))
          this.menuItems.push(
            {
              title: this.dic.translate('IT'), status: true, icon: 'fe fe-calendar', type: 'link', path: '/group/it',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:hr'))
          this.menuItems.push(
            {
              title: this.dic.translate('Human resource'), status: true, icon: 'fe fe-user', type: 'link', path: '/group/hr',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
          if (resources.includes('group:supplychain'))
          this.menuItems.push(
            {
              title: this.dic.translate('Supplychain'), status: true, icon: 'fa fa-shopping-bag', type: 'link', path: '/group/scd',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:pmo'))
          this.menuItems.push(
            {
              title: this.dic.translate('PMO'), status: true, icon: 'fe fe-user', type: 'link', path: '/group/pmo',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:accounting-and-control'))
          this.menuItems.push(
            {
              title: this.dic.translate('Accounting and control'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/accounting-and-control',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:finance'))
          this.menuItems.push(
            {
              title: this.dic.translate('Finance'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/finance',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:legal'))
          this.menuItems.push(
            {
              title: this.dic.translate('Legal'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/legal',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:properties'))
          this.menuItems.push(
            {
              title: this.dic.translate('Properties'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/properties',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:administration'))
            this.menuItems.push(
              {
                title: this.dic.translate('Administration'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/administration', badgeType: 'success', badgeValue: '2', active: false,
              },
            )
            if (resources.includes('group:commercial'))
            this.menuItems.push(
          {
            title: this.dic.translate('Commercial'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/commercial',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
          },
          )
        ...
        if (resources.includes('group:machines'))
          this.menuItems.push(
            {
              title: this.dic.translate('Machines'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/machines',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('group:safety'))
          this.menuItems.push(
            {
              title: this.dic.translate('Safety'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/safety',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        ...
        if (resources.includes('group:landscape'))
          this.menuItems.push(
            {
              title: this.dic.translate('Landscape'), status: true, icon: 'fa fa-home', type: 'link', path: '/group/landscape',queryParams:{}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
