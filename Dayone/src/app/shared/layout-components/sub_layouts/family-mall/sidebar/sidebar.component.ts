...
export class SidebarFMComponent {
  ...
  checkNavActiveOnLoad() {
    ...
    this.httpService.call('userinfo', ApiMethod.GET, {}).subscribe((res: any) => {
      if (res.status == true) {
        ...
        this.menuItems.push(
          {
            title: this.dic.translate('Home'), status: true, icon: 'fe fe-home', type: 'link', path: '/fm', badgeType: 'success', badgeValue: '2', active: false,
          },
        )
        if (resources.includes('fm:poney'))
          this.menuItems.push(
            {
              title: this.dic.translate('Poney'), status: true, icon: 'fe fe-calendar', type: 'link', path: '/fm/poney',queryParams:{from_date:this.from,to_date:this.to}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('fm:pax-gym'))
          this.menuItems.push(
            {
              title: this.dic.translate('Pax Gym'), status: true, icon: 'fe fe-user', type: 'link', path: '/fm/pax-gym',queryParams:{from_date:this.from,to_date:this.to}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('fm:sales-per-date'))
          this.menuItems.push(
            {
              title: this.dic.translate('Sales per date'), status: true, icon: 'fa fa-calendar', type: 'link', path: '/fm/sales-per-date',queryParams:{from_date:this.from,to_date:this.to}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
        if (resources.includes('fm:sales-per-product-type'))
          this.menuItems.push(
            {
              title: this.dic.translate('Sales per product type'), status: true, icon: 'fa fa-dollar', type: 'link', path: '/fm/sales-per-product-type',queryParams:{from_date:this.from,to_date:this.to}, badgeType: 'success', badgeValue: '2', active: false,
            },
          )
