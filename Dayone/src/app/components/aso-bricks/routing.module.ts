...
import { AbfMainComponent } from './components/main/component';
...
const routes: Routes = [
  {
    ...
    children: [
      {
        path: '',
        component: AbfMainComponent,
        canActivate: [RoleGuard],
        data: {
          expectedRole: 'abf:read'
        }
      },
      {
        path: 'main',
      ...
      },
      {
        ...
        canActivate: [RoleGuard],
        data: {
          expectedRole: 'abf:inventory-now'
        }
      },
      {
        ...
        canActivate: [RoleGuard],
        data: {
          expectedRole: 'abf:inventory-and-sold-per-date'
        }
      },
      {
        path: 'sales-per-gov',
        ...
        canActivate: [RoleGuard],
        data: {
          expectedRole: 'abf:sales-per-gov'
        }
      },
      {
        ...
        canActivate: [RoleGuard],
        data: {
          expectedRole: 'abf:sales-per-month'
        }
      },
      {
        ...
        canActivate: [RoleGuard],
        data: {
          expectedRole: 'abf:sales-per-brick-type'
        }
      },
      {
        ...
        canActivate: [RoleGuard],
        data: {
          expectedRole: 'abf:sales-per-customer'
        }
      },
