...
export class PerformanceReportComponent implements OnInit {
  ...
  constructor(
    ...
    this.http
      .call('group/reporting/users', ApiMethod.GET, { skip: 0, limit: 10000, sort: 'name' })
      .subscribe((ptr: any) => {
        this.it_staffs = [];
        if (ptr.data)
  ...
  ngOnInit(): void {
    ...
    if (this.p.year && !this.p.staff_id) {
      this.http
        .call('group/reporting/employee_and_unit_kpi', ApiMethod.GET, {
          year: this.p.year,
        })
        .subscribe((ptr: any) => {
    ...
    if (this.p.year && this.p.staff_id) {
      this.monthly_avg = 0;
      this.http
        .call('group/reporting/staff_report', ApiMethod.GET, {
          year: this.p.year,
  ...
  changeMonth(event?: any) {
    ...
    this.http
      .call('group/reporting/staff_monthly_report', ApiMethod.GET, {
        year: this.p.year,
        month: this.p.month,
        staff_id: this.p.staff_id,
        leave: this.p.leave,
