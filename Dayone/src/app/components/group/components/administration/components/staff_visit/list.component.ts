...
export class StaffVisitReportComponent implements OnInit {
  bercumberRoutes: any = [
    ...
    { icon: 'feather feather-home', route: '/group/administration', name: 'Administration' },
    // {
    //   icon: 'fe fe-codepen',
    //   route: '/visits',
  ...
  getTotalVisitForCompanies() {
    this.DataIsLoading = true;
      this.http.call('group/booking/staff_visit', ApiMethod.GET, this.p).subscribe((ptr: any) => {
