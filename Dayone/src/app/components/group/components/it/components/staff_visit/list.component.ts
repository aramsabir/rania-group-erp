...
export class ITStaffVisitReportComponent implements OnInit {
  bercumberRoutes: any = [
    { icon: 'feather feather-home', route: '/home', name: 'Home' },
    { icon: 'feather feather-home', route: '/group', name: 'Group' },
    { icon: 'feather feather-home', route: '/group/it', name: 'IT' },
    // {
    //   icon: 'fe fe-codepen',
    //   route: '/visits',
  ...
  getTotalVisitForCompanies() {
    this.DataIsLoading = true;
      this.http.call('group/it/staff_visit', ApiMethod.GET, this.p).subscribe((ptr: any) => {
