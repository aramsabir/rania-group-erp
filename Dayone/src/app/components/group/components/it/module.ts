...
import { ITRoutingModule } from './routing.module';
...
import { ITMainComponent } from './component';
...
import { ITStaffVisitReportComponent } from './components/staff_visit/list.component';
...
@NgModule({
  declarations: [
    ITMainComponent,
    ITStaffVisitReportComponent,
    WorkPercentageReportComponent,
