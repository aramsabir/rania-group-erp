      ...
      if (res.status == true) {
        ...
        if (res.data.role_id)
          ...
          this.arrayLinks.push({
            active: true,
            type: 'router',
            router: '/group/scd/performance',
            query: {year:this.year},
            name: 'KPI',
            logo: './assets/images/main-logo/kpi.png',
          });
          // this.arrayLinks.push({
          //   active: true,
          //   type: 'router',
          //   router: '/group/hr/plan',
          //   query: {},
          //   name: 'Plan',
          ...
          this.arrayLinks.push({
            active: true,
            type: 'router',
            router: '/group/scd/work-percentage',
            query: {year:this.year},
