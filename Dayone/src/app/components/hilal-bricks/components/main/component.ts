...
@Component({
  selector: 'app-hbf-miain',
  templateUrl: './component.html',
  styleUrls: ['./component.scss'],
})
export class HbfMainComponent implements OnInit {
  bercumberRoutes: any = [
      ...
      if (res.status == true) {
        ...
        if (resources.includes('hbf:sales-per-month')) {
          this.arrayLinks.push({
            active: true,
            router: '/hilal-bricks/sales-per-month',
        ...
        if (resources.includes('hbf:sales-per-customer')) {
          this.arrayLinks.push({
            active: true,
            router: '/hilal-bricks/sales-per-customer',
        ...
        if (resources.includes('hbf:sales-per-gov')) {
          this.arrayLinks.push({
            active: true,
            router: '/hilal-bricks/sales-per-gov',
            query: { from_date: this.from_date, to_date: this.to_date },
        ...
        if (resources.includes('hbf:sales-per-brick-type')) {
          this.arrayLinks.push({
            active: true,
            router: '/hilal-bricks/sales-per-brick-type',
            query: { from_date: this.from_date, to_date: this.to_date },
        ...
        if (resources.includes('hbf:inventory-now')) {
          this.arrayLinks.push({
            active: true,
            router: '/hilal-bricks/inventory-now',
            query: { },
            name: 'Inventory now',
        ...
        if (resources.includes('hbf:inventory-and-sold-per-date')) {
          this.arrayLinks.push({
            active: true,
            router: '/hilal-bricks/inventory-and-sold',
