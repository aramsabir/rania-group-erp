...
@Component({
  selector: 'app-hbf-inventory-and-sold',
  templateUrl: './component.html',
  styleUrls: ['./component.scss'],
})
export class InventoryAndSoldComponent implements OnInit {
  params: any = {};
  apiUrl: string;
  titlePage: string = "Inventory & sold per date";
  lang: string;
  model: any = {};
  govs: any = GOVS;
  ...
  getData() {
    ...
    this.httpService
      .call('hbf/inventory_by_date', ApiMethod.GET, this.model)
      .subscribe((res: any) => {
        if (res.status) {
          this.data = res.list;
