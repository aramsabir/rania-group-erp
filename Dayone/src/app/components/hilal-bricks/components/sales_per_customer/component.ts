...
@Component({
  selector: 'app-hbf-revenue-per-customer',
  templateUrl: './component.html',
  styleUrls: ['./component.scss'],
})
export class RevenuePerCustomerComponent implements OnInit {
  params: any = {};
  apiUrl: string;
  ...
  govs: any = GOVS;
  customerTypes: any = [
    {caption:'Dealer',value:'dealer'},
    {caption:'Project',value:'project'},
  ...
  getData() {
    ...
    this.httpService
      .call('hbf/sales_per_customer_type', ApiMethod.GET, this.model)
      .subscribe((res: any) => {
        if (res.status) {
          this.data = res.list;
