...
@Component({
  selector: 'app-hcnt-sales-per-brick-type',
  templateUrl: './component.html',
  styleUrls: ['./component.scss'],
})
export class SalesPerConcreteTypeComponent implements OnInit {

  titlePage: string = "Sales per product type";
  actions:any =[]
  bercumberRoutes: any = [
  ...
  getData() {
    ...
    this.httpService
      .call('hcnt/sales_per_product_type', ApiMethod.GET, this.model)
      .subscribe((res: any) => {
        if (res.status) {
          this.data = res.list;
