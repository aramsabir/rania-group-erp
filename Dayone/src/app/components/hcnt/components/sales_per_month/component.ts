...
@Component({
  selector: 'app-hcnt-sales-per-month',
...
export class SalesPerMonthComponent implements OnInit {
  ...
  titlePage: string = "Sales per month";
  actions:any =[]
  bercumberRoutes: any = [
  ...
  getData() {
    ...
    this.httpService
      .call('hcnt/sales_per_month', ApiMethod.GET, this.model)
      .subscribe((res: any) => {
        if (res.status) {
          this.data = res.list;
            ...
            chart: {
              ...
              events: {
                ...
                drillup: () => {
                  ...
                  this.totalDetail.meters = 0
                  this.totalDetail.orders = 0
                  document.getElementById('search_row')!.style.display =
                    'block';
                },
              },
            },
