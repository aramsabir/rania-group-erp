...
export class SeoService implements OnDestroy {
  ...
  constructor(
    ...
    private metaService: Meta, private dic: DicService,
  ) {}
  ...
  private getLatestChild(): ActivatedRoute {
   ...
   setTitle(rootTitle: string, title: string): void {
    if (title) {
      this.titleService.setTitle(`${rootTitle} - ${this.dic.translate(title)}`);
    }
  }
